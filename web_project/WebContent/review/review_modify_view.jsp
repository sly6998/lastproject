...
<h3 >REVIEW 수정</h3>
    ...
    <table>
     	<tr>
        	<td>
        		<input name="REVIEW_SUBJECT" class="form-control" type="text" placeholder="제목을 입력하세요." value="<%=review.getREVIEW_SUBJECT()%>" size="100%" /><br />
            	<p>
            </td>
		</tr>
        ...
        <tr>
            <td align="center">
            	<p /><br />
            	<input type="button" value="수정" class="btn" onclick="review_modify_check()" />
            	<input type="button" class="btn" value="돌아가기" onclick="location.href='./review_list.html'" />
            </td>
		</tr>					
    </table>
     </form>
