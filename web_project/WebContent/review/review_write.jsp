...
<body>
    ...
    <section id="content">
      ...
      <form name="review_write_form" method="post" action="./ReviewWriteAction.html">
         <input type="hidden" name="REVIEW_MEMBER_ID" value="<%=id %>"/>
          <input type="hidden" name="REVIEW_MEMBER_NAME" value="<%=MEMBER_NAME%>" />
         <table>
            <tr>
            ...
            <tr>
               ...
               <input type="button" class="btn" value="글등록" onclick="review_write_check()">&nbsp;&nbsp;&nbsp;
              
               <input type="button" class="btn" value="돌아가기" onclick="location.href='./review_list.html'"></td>
            </tr>
