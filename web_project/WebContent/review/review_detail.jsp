...
<%
  ...
  List review_reply = (List) request.getAttribute("reviewreplylist");
%>
...
<body>
    ...
    <section id="content">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <!-- 본문 시작 -->
            <h3 class="heading">Review 게시판</h3>
            <br> <br>
            ...
            <form>
              <%
                for (int i = 0; i < review_reply.size(); i++) {
                  ReviewBean rl = (ReviewBean) review_reply.get(i);
              %>
              <table width="100%">
                <tr style="border-bottom: 1px;">
                  ...
                  <td align="right">
                    ...
                    href='./ReviewReplyModifyViewAction.html?REVIEW_NUM=<%=review.getREVIEW_NUM()%>&REVIEW_REPLY_SEQ=<%=rl.getREVIEW_REPLY_SEQ()%>'>수정&nbsp;&nbsp;&nbsp;</a> <a style="text-decoration: none;"
                    href='./ReviewReplyDeleteAction.html?REVIEW_NUM=<%=review.getREVIEW_NUM()%>&REVIEW_REPLY_SEQ=<%=rl.getREVIEW_REPLY_SEQ()%>'>삭제&nbsp;&nbsp;&nbsp;</a> <%
   }
 ...
 %>
            ...
            <table width="100%">
              ...
              %>
              <form name="review_reply_write_form" method="post" action="./ReviewReplyWriteAction.html">
                <tr>
                  <td><br>
                  <br></td>
                </tr>
                <tr>
                  ...
                  <td width="10%" align="center"><input type="submit" class="btn" name="review_reply_write_form" value="등록"></td>
                </tr>
              </form>
              <%
                }
