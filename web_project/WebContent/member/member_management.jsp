...
<body>
      ...
      <div class="container" align="center">
        <div class="row">
          <div class="col-lg-12">
            <br> <br>
            <!-- 본문 시작 -->
            <h3 class="heading" align="left" style="margin-left: 120px;">회원 관리</h3>
            <div align="right" style="width: 80%;">
              <form name="srchForm" action="./member_management.html" method="post">
                <select name="srchFlds" class="form-control-u" style="width: 80px;">
                  ...
                  <option value="num" <%=srchFlds.equals("num") ? "selected='selected'" : ""%>>회원번호</option>
                  <option value="id" <%=srchFlds.equals("id") ? "selected='selected'" : ""%>>아이디</option>
                  <option value="name" <%=srchFlds.equals("name") ? "selected='selected'" : ""%>>이름</option>
                </select> <input type="text" name="srchKey" size="20" maxlength="50" value="<%=srchKey%>" /> <input type="button" class="btn" value="검색" onClick="submitSrchForm()" />
              </form>
              <br />
            </div>
            <table class="table table-hover" style="width: 80%">
              <tr align="center" style="background-color: #EFEFEF">
                <td style="font-size: 12pt; font-weight: bold; width: 100px;">
                  <div align="center">회원번호</div>
                </td>

                <td style="font-size: 12pt; font-weight: bold; width: 200px;">
              ...
              <tr align="center" valign="middle" style="border: 1px solid #ddd;" onmouseover="this.style.backgroundColor='#F8F8F8'">
                <td height="23" style="font-family: Tahoma; font-size: 10pt; border: 0px solid #000;"><%=bl.getMEMBER_NUM()%></td>

                <td style="font-family: Tahoma; font-size: 10pt; border: 0px solid #000;"><%=bl.getMEMBER_ID()%></td>
 ...
 %> <a href="./member_management.html?page=<%=nowpage - 1%>">[이전]</a>&nbsp; <%
   }
 %> <%
