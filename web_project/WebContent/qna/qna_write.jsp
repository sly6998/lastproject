...
<body>
    ...
    <section id="content">
      ...
      <form name="qna_write_form" method="post" action="./QnaWriteAction.html">
         <input type="hidden" name="QNA_MEMBER_ID" value="<%=id %>"/>
          <input type="hidden" name="QNA_MEMBER_NAME" value="<%=MEMBER_NAME%>" />
         <table>
            <tr>
               <td><input name="QNA_SUBJECT" class="form-control" type="text" placeholder="제목을 입력하세요." size="100%" /><br />
               <p></td>
            </tr>

            <TR>
               <td>
               		<textarea name="QNA_CONTENT" id="contents"></textarea>
               </td>
            </TR>
            ...
            <tr>
               ...
               <input type="button" class="btn" value="글등록" onclick="qna_write_check()">&nbsp;&nbsp;&nbsp;
              
               <input type="button" class="btn" value="돌아가기" onclick="location.href='./qna_list.html'"></td>
            </tr>
         </table>
      </form>
   </div>
