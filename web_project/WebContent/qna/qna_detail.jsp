...
<%
  ...
  List qna_reply = (List) request.getAttribute("qnareplylist");
%>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            ...
            <form>
              <%
                for (int i = 0; i < qna_reply.size(); i++) {
                  QnaBean rl = (QnaBean) qna_reply.get(i);
              %>
              <table width="100%">
                <tr style="border-bottom: 1px;">
                  ...
                  <td align="right">
                    ...
                    href='./QnaReplyModifyViewAction.html?QNA_NUM=<%=qna.getQNA_NUM()%>&QNA_REPLY_SEQ=<%=rl.getQNA_REPLY_SEQ()%>'>수정&nbsp;&nbsp;&nbsp;</a> <a style="text-decoration: none;"
                    href='./QnaReplyDeleteAction.html?QNA_NUM=<%=qna.getQNA_NUM()%>&QNA_REPLY_SEQ=<%=rl.getQNA_REPLY_SEQ()%>'>삭제&nbsp;&nbsp;&nbsp;</a> <%
   }
