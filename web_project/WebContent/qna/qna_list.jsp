...
<link href="<%=request.getContextPath()%>/css/bootstrap.min.css"
	rel="stylesheet" />
<link
	href="<%=request.getContextPath()%>/css/fancybox/jquery.fancybox.css"
	rel="stylesheet">
<link href="<%=request.getContextPath()%>/css/jcarousel.css"
	rel="stylesheet" />
...
<link href="<%=request.getContextPath()%>/css/style.css"
	rel="stylesheet" />
<!-- Theme skin -->
<link href="<%=request.getContextPath()%>/skins/default.css"
	rel="stylesheet" />
<!-- Script -->
...
<script
	src="<%=request.getContextPath()%>/js/google-code-prettify/prettify.js"></script>
<script
	src="<%=request.getContextPath()%>/js/portfolio/jquery.quicksand.js"></script>
				...
				<div class="navbar-collapse collapse ">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle "
							...
							data-close-others="false">Member<b class=" icon-angle-down"></b></a>
							<ul class="dropdown-menu">
								<%
									if (id == null || id == "") {
								%>
								<li><a href="./login.html" data-toggle="modal"
									data-target="#loginModal">로그인</a></li>
								<li><a href="./join.html" data-toggle="modal"
									data-target="#joinModal">회원가입</a></li>
								<li><a href="./idfind.html" data-toggle="modal"
									data-target="#idModal">ID 찾기</a></li>
								<li><a href="./pwdfind.html" data-toggle="modal"
									data-target="#pwdModal">PWD 찾기</a></li>
								<%
	...
	<section id="content">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<!-- 본문 시작 -->
					<h3 class="heading">질문게시판</h3>
					<!-- 검색 기능 추가 -->
					<div width="100%" align="right">
						<form name="srchForm" action="./qna_list.html" method="post">
							<select name="srchFlds" class="form-control-u"
								style="width: 80px;">
								<option value="all"
							...
							</select> <input type="text" name="srchKey" class="form-control-u"
								style="width: 250px" maxlength="50" value="<%=srchKey%>" /> <input
								type="button" value="검색" class="btn" onClick="submitSrchForm()" />
						</form>
					</div>
					<p />
					...
					<table class="table table-hover" width="100%">
						...
						<tr align="center" style="background-color: #EFEFEF">
							<td style="font-size: 12pt; font-weight: bold; width: 80px;"
								height="26">
							...
							<td style="font-size: 12pt; font-weight: bold;" width="150"
								height="26">
						...
						<tr align="center" valign="middle" >
							...
							<td align="center">
								<a class="navbar-link"
								href="./qna_detail.html?QNA_NUM=<%=bl.getQNA_NUM()%>"
								style='text-decoration: none;'> <%=bl.getQNA_SUBJECT()%>
							</a> &nbsp;[<%=bl.getQNA_REPLY_AMOUNT()%>]
							</td>
