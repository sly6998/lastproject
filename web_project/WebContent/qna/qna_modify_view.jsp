...
<h3 >QNA게시판 수정</h3>
    ...
    <table>
     	...
     	<tr>
        	<td>
        		<input name="QNA_SUBJECT" class="form-control" type="text" placeholder="제목을 입력하세요." value="<%=qna.getQNA_SUBJECT()%>" size="100%" /><br />
            	<p>
            </td>
		</tr>
     	...
     	<TR>
        	<td>
        		<textarea id="contents" name="QNA_CONTENT"><%=qna.getQNA_CONTENT() %></textarea>
        	</td>
        </TR>
        ...
        <tr>
            <td align="center">
            	<p /><br />
            	<input type="button" value="수정" class="btn" onclick="qna_modify_check()" />&nbsp;&nbsp;&nbsp; 
            	<input type="button" class="btn" value="돌아가기" onclick="location.href='./qna_list.html'" />
            </td>
		</tr>
    </table>
