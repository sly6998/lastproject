        ...
        <div class="col-lg-12">
          ...
          <table class="table table-hover">
            ...
            <tr align="center" style="background-color: #EFEFEF">
              <td align="center" style="font-size: 12pt; font-weight: bold; width: 100px;">번호</td>
              <td align="center" style="font-size: 12pt; font-weight: bold; width: 100px;">이름</td>
              <td align="center" style="font-size: 12pt; font-weight: bold; width: 100px;">연락처</td>
              <td align="center" style="font-size: 12pt; font-weight: bold; width: 100px;">신청일</td>
            </tr>
            <%
            ...
            <!-- 내용 -->
            <tr>
              <td align="center"><%=bl.getADVICE_NUM()%></td>
              <td align="center"><a href="./advice_detail.html?ADVICE_NUM=<%=bl.getADVICE_NUM()%>"><%=bl.getADVICE_NAME()%></a></td>
              <td align="center"><%=bl.getADVICE_TEL()%></td>
              <td align="center"><%=bl.getADVICE_DATE()%></td>
            </tr>
            <%
              }
            %>
