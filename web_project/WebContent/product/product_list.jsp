        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div>
                  <a href="./product_detail.html?item_seq=<%=il.getITEM_SEQ()%>" style='text-decoration:none;'><img src="<%=request.getContextPath()%>/upload/main_upload/<%=il.getITEM_IMAGE()%>" width="350" height="250" /></a>
                </div>
                <br><p align="center">
                  <a href="./product_detail.html?item_seq=<%=il.getITEM_SEQ()%>" style='text-decoration:none;'><b><%=il.getITEM_NAME()%></b></a>
                </p>
                <div align="center">
                  <span style="display:block; height:80px;"><b><%=String.format("%,d", il.getITEM_PRICE())+" 원"%></b></span>
                </div>
              </div>
            ...
            <div align="right">
              <%
                if (id.equals("admin")) {
              %>
              <input type="button" class="btn" value="제품 등록" onclick="location.href='./product_write_view.html'">
              <%
                }
              %>
            </div>
            ...
            <div align="center">
              ...
              %>
              <a href="./product_list.html?page=<%=nowpage - 1%>">[이전]</a>&nbsp;
              <%
                }
              %>
              <%
              ...
              %>
              <a href="./product_list.html?page=<%=a%>">[<%=a%>]
              </a> &nbsp;
              <%
                }
              %>
              ...
              %>
              <a href="./product_list.html?page=<%=nowpage + 1%>">[다음]</a>
              <%
                }
              %>
            </div>
