...
<%
  ...
  NotiBean noti = (NotiBean) request.getAttribute("ssibal");
...
<body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            ...
            <br> <br>
            <form method="post" action="./noti_modify_view.html">
              <input type="hidden" name="NOTI_NUM" value="<%=noti.getNOTI_NUM()%>">
              <table class="table">
                <tr>
                  <td width="15%" bgcolor="eeeeee">제목</td>
                  <td width="85%"><%=noti.getNOTI_SUBJECT()%></td>
                </tr>
                <tr>
                  <td width="15%" bgcolor="eeeeee">작성자</td>
                  <td width="85%"><%=noti.getNOTI_MEMBER_NAME()%></td>
                </tr>
                <tr>
                  <td width="15%" bgcolor="eeeeee">작성일</td>
                  <td width="85%"><%=noti.getNOTI_DATE()%></td>
                </tr>
                <tr>
                  <td colspan="2"><%=noti.getNOTI_CONTENT()%></td>
                </tr>
              </table>
            ...
            <form>
              <%
                for (int i = 0; i < replylist.size(); i++) {
                  NotiBean rl = (NotiBean) replylist.get(i);
              %>
              <table width="100%">
                <tr style="border-bottom: 1px;">
                  ...
                  <td align="right">
                    ...
                    %> <a style="text-decoration: none;" href='./NotiReplyModifyViewAction.html?NOTI_NUM=<%=noti.getNOTI_NUM()%>&NOTI_REPLY_SEQ=<%=rl.getNOTI_REPLY_SEQ()%>'>수정&nbsp;&nbsp;&nbsp;</a> <a
                    style="text-decoration: none;" href='./NotiReplyDeleteAction.html?NOTI_NUM=<%=noti.getNOTI_NUM()%>&NOTI_REPLY_SEQ=<%=rl.getNOTI_REPLY_SEQ()%>'>삭제&nbsp;&nbsp;&nbsp;</a> <%
   }
 ...
 %> <a style="text-decoration: none;" href="#">답글&nbsp;&nbsp;&nbsp;</a>
            ...
            <table width="100%">
              ...
              %>
              <form name="noti_reply_modify_form" method="post" action="./NotiReplyModify.html">
                <tr>
                  <td><br> <br></td>
                </tr>
                <tr>
                  <td width="10%"><input type="hidden" name="NOTI_REPLY_MEMBER_ID" value="<%=id%>" /> 
                  <input type="hidden" name="num" value="<%=noti.getNOTI_NUM()%>" /> 
                  <b><%=id%></b></td>
